...
In order to support loading of multiple wallets in pulse-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is pulse.cpp.
...
Changes to pulse.cpp
----------------------
pulse.cpp is the entry point into pulse-qt, and as such, will require some minor modifications to provide hooks for
