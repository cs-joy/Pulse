                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzPLSEPathCustom = GetArg("-zplsebackuppath", "");
    ...
    if(!strzPLSEPathCustom.empty()) {
        ui->wallet_customzplsebackuppath->setText(QString::fromStdString(strzPLSEPathCustom));
        ui->wallet_customzplsebackuppath_label->setVisible(true);
        ui->wallet_customzplsebackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzPLSEPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the Pulse RPC console.") + "<br>" +
