...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("nDisplayUnit"))
        settings.setValue("nDisplayUnit", BitcoinUnits::PLSE);
...
// Wallet
    ...
    if (settings.contains("nAnonymizePulseAmount"))
        SoftSetArg("-anonymizepulseamount", settings.value("nAnonymizePulseAmount").toString().toStdString());
...
void OptionsModel::Reset()
{
    ...
    settings.clear();
    resetSettings = true; // Needed in pulse.cpp during shotdown to also remove the window positions
