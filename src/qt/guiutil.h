...
/** Utility functions used by the Pulse Qt UI.
 */
namespace GUIUtil
{
...
// Render Pulse addresses in monospace font
...
// Parse "pulse:" URI into recipient object, return true on successful parsing
