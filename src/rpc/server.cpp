...
static const CRPCCommand vRPCCommands[] =
{
        ...
        /* Pulse features */
        {"pulse", "masternode", &masternode, true, true, false},
        {"pulse", "listmasternodes", &listmasternodes, true, true, false},
        {"pulse", "getmasternodecount", &getmasternodecount, true, true, false},
        {"pulse", "masternodeconnect", &masternodeconnect, true, true, false},
        {"pulse", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"pulse", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"pulse", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"pulse", "masternodecurrent", &masternodecurrent, true, true, false},
        {"pulse", "masternodedebug", &masternodedebug, true, true, false},
        {"pulse", "startmasternode", &startmasternode, true, true, false},
        {"pulse", "createmasternodekey", &createmasternodekey, true, true, false},
        {"pulse", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"pulse", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"pulse", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"pulse", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"pulse", "getmasternodescores", &getmasternodescores, true, true, false},
        {"pulse", "mnbudget", &mnbudget, true, true, false},
        {"pulse", "preparebudget", &preparebudget, true, true, false},
        {"pulse", "submitbudget", &submitbudget, true, true, false},
        {"pulse", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"pulse", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"pulse", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"pulse", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"pulse", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"pulse", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"pulse", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"pulse", "checkbudgets", &checkbudgets, true, true, false},
        {"pulse", "mnsync", &mnsync, true, true, false},
        {"pulse", "spork", &spork, true, true, false},
        {"pulse", "getpoolinfo", &getpoolinfo, true, true, false},
...
{
    return "> pulse-cli " + methodname + " " + args + "\n";
}
