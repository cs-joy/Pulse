...
extern UniValue setzplseseed(const UniValue& params, bool fHelp);
extern UniValue getzplseseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdzplse(const UniValue& params, bool fHelp);
extern UniValue dzplsestate(const UniValue& params, bool fHelp);
