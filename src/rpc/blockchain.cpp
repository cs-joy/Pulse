...
UniValue getrawmempool(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() > 1)
        throw runtime_error(
            ...
            "    \"fee\" : n,              (numeric) transaction fee in pulse\n"
...
UniValue getblock(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() < 1 || params.size() > 2)
        throw runtime_error(
            ...
            "  \"zPLSEsupply\" :\n"
            "  {\n"
            "     \"1\" : n,            (numeric) supply of 1 zPLSE denomination\n"
            "     \"5\" : n,            (numeric) supply of 5 zPLSE denomination\n"
            "     \"10\" : n,           (numeric) supply of 10 zPLSE denomination\n"
            "     \"50\" : n,           (numeric) supply of 50 zPLSE denomination\n"
            "     \"100\" : n,          (numeric) supply of 100 zPLSE denomination\n"
            "     \"500\" : n,          (numeric) supply of 500 zPLSE denomination\n"
            "     \"1000\" : n,         (numeric) supply of 1000 zPLSE denomination\n"
            "     \"5000\" : n,         (numeric) supply of 5000 zPLSE denomination\n"
            "     \"total\" : n,        (numeric) The total supply of all zPLSE denominations\n"
            "  }\n"
            "}\n"
...
UniValue gettxout(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() < 2 || params.size() > 3)
        throw runtime_error(
            ...
            "     \"addresses\" : [          (array of string) array of pulse addresses\n"
            "     \"pulseaddress\"   	 	(string) pulse address\n"
            "        ,...\n"
            "     ]\n"
            "  },\n"
