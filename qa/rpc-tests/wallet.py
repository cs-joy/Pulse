...
#   c) node1 mines 32 blocks, so now node 0 has 60001plse, node 1 has 4250plse, node2 has none.
#   d) node0 sends 601 plse to node2, in two transactions (301 plse, then 300 plse).
