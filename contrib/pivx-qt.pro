...
RESOURCES += src/qt/pulse.qrc src/qt/pulse_locale.qrc

TRANSLATIONS += src/qt/locale/pulse_bg.ts \
                src/qt/locale/pulse_de.ts \
                src/qt/locale/pulse_en.ts \
                src/qt/locale/pulse_es.ts \
                src/qt/locale/pulse_fi.ts \
                src/qt/locale/pulse_fr.ts \
                src/qt/locale/pulse_it.ts \
                src/qt/locale/pulse_ja.ts \
                src/qt/locale/pulse_pl.ts \
                src/qt/locale/pulse_pt.ts \
                src/qt/locale/pulse_ru.ts \
                src/qt/locale/pulse_sk.ts \
                src/qt/locale/pulse_sv.ts \
                src/qt/locale/pulse_vi.ts \
                src/qt/locale/pulse_zh_CN.ts \
                src/qt/locale/pulse_zh_TW.ts
